...
{
    public class FlatGeocode : AbstractGeocode, IGeocode
    {
        ...
        public new double MatchScore { get; set; }
        public new string MatchedLocationType { get; set; }

        public new string MatchType { get; set; }

        public new string CoordinateString { get; set; }
        ...
        public FlatGeocode(double version)
            : base(version) { }
